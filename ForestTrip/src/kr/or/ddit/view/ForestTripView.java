...
//		String user_pw = ScanUtil.nextLine("비밀번호 : ");
	...
	protected View userMyPage() {
		...
		System.out.println("1.마이페이지에는 회원가입시 기입했던 정보 출력");
		System.out.println("2.자기가 갔던 휴양림 목록 출력");
		System.out.println("3.목록번호 선택 시 mypageForestReview로 넘어감(리뷰작성)");
